...
/**
 * Interface for an Iterable, Indexed, Unsorted List ADT. Iterators and ListIterators provided by
 * the list are required to be "fail-fast" and throw ConcurrentModificationException if the iterator
 * detects any change to the list from another source. Note: "Unsorted" only means that it is not
...
public interface IndexedUnsortedList<T> extends Iterable<T> {
	...
	/**
	 * Returns a ListIterator for the elements in this list, with the iterator positioned before the
	 * specified index.
	 * 
	 * @param startingIndex
	 *
